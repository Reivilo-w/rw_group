...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            interaction.reply({content: 'Encore en cours de développement.', ephemeral: true, files: [sfattach]})
        } catch (exception) {
            console.log(exception);
            interaction.reply({content: 'Impossible de récupérer les stats, réessayez plus tard.', ephemeral: true})
        }
    },
};
